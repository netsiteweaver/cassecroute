...
<div class="row mb-3">
    ...
    <div class="col-xs-6 col-sm-4 col-md-1" style='margin-top:23px;'>
        <a href="<?php echo base_url("products/add?referer=products/listing/".$this->uri->segment(3)); ?>">
            <button type="button" class="btn btn-success btn-block"><i class="fa fa-plus"></i> Add</button>
        </a>
    </div>
    <?php endif; ?>
    <div class="col-xs-1 float-right" style='margin-top:23px;'>
        <label for="">&nbsp;</label>
        <div class="btn btn-md bg-purple re-order"><i class="fa fa-sort"></i> Display Order</div>
    </div>
    ...
    <div class="col-xs-6 col-sm-4 col-md-2">
        ...
        <select class="form-control" name="category_id" id="category_id">
            ...
            <!-- <option value="10" <?php echo ( (empty($rows_per_page)) || ($rows_per_page == 10) ) ? 'selected':'';?>>10 rows</option> -->
            <option value="<?php echo $pc->id;?>" <?php echo ($pc->id == $this->input->get("category_id")) ? 'selected':'';?>><?php echo $pc->name;?></option>
            <?php endforeach;?>
        </select>
    </div>
    <div class="col-xs-6 col-sm-4 col-md-2">
