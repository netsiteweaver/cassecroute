<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li id='messages-dropdown-block' class="nav-item dropdown <?php echo (!empty($unread_messages))?'':'d-none';?>">
        <a class="nav-link" data-toggle="dropdown" href="#">
      ...
      <li class='nav-item'>
        <a href="<?php echo base_url('backoffice/off'); ?>" class="nav-link">
          <i class="fa fa-chevron-left"></i> <span>Back</span>
        </a>
      </li>   
      <?php else:?>
      <li class="nav-item">
        <a href="<?php echo base_url('backoffice/on'); ?>" class="nav-link">
